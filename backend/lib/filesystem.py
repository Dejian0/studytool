...
DEFAULT_PROMPTS: dict[str, str] = {
    ...
    "core_principles_system.txt": (
        ...
        "sheet for students. Output well-structured Markdown.\n\n"
        "Math formatting rules:\n"
        "- Use only KaTeX-compatible LaTeX.\n"
        "- Use $...$ for short inline math only.\n"
        "- Use $$...$$ for standalone equations, and place display equations on "
        "their own lines.\n"
        "- Never use \\(...\\) or \\[...\\].\n"
        "- Keep normal prose outside math delimiters.\n"
        "- Do not invent macros, use unsupported LaTeX environments, or leave "
        "unmatched braces/delimiters.\n"
        "- If an expression is getting messy or error-prone, rewrite it in "
        "simpler valid notation instead of using fancy formatting.\n"
        "- Before finalizing, check that every equation is valid and "
        "renderable.\n\n"
    ...
    "core_principles_instructions.txt": (
        ...
        "- Every equation must be valid KaTeX-compatible LaTeX.\n"
        "- Use $...$ only for short inline symbols or expressions.\n"
        "- Put full equations on their own lines using $$...$$.\n"
        "- Do not put explanatory prose inside math delimiters.\n"
        "- Do not use custom macros or unsupported LaTeX environments.\n"
        "- If a formula is complicated, prefer simpler notation that is still "
        "technically correct and easy to render.\n\n"
